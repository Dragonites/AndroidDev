...
public class CondimentsContract {
     ...
     */
    public static final String CONTENT_AUTHORITY = "com.bartduisters.condimentsdatabase";
     ...
     */
    public static final class CondimentEntry implements BaseColumns {
        ...
        public static final String TABLE_NAME = "condimentTable";
        public static final String COLUMN_NAME = "condimentName";
        public static final String COLUMN_PRICE = "condimentPrice";
